...
import com.example.loultimoennoticiascolombia.databinding.ActivityCategoryBinding
...
class CategoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonPoliticaDePrivacidad: Button = findViewById(R.id.buttonPoliticaPrivacidad)
        buttonPoliticaDePrivacidad.setOnClickListener{

            val intent: Intent = Intent(this, PoliticaPrivacidad_activity::class.java)

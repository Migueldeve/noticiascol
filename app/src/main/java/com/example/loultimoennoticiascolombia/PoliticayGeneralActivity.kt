...
import com.example.loultimoennoticiascolombia.databinding.ActivityPoliticaYGeneralBinding
...
class PoliticayGeneralActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonSemana: Button = findViewById(R.id.buttonSemana)
        buttonSemana.setOnClickListener{
        ...
        if (mInterstitialAd != null){
            ...
            mInterstitialAd?.fullScreenContentCallback = object : FullScreenContentCallback(){
                ...
                override fun onAdFailedToShowFullScreenContent(p0: AdError) {
                    ...
                    val intent = Intent(this@PoliticayGeneralActivity, WebViewSemana1_Activity::class.java)
            ...
            val intent = Intent(this, WebViewSemana1_Activity::class.java)
            startActivity(intent)
